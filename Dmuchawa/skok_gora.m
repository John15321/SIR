...
T1 = 1.3;           %USER   Sta³a czasowa wyznaczona z wykresów - ta mniejsza
T2 = 7;             %USER   Sta³a czasowa wyznaczona z wykresów - ta wiêksza
skokQ = 3000;       %USER   ró¿nica amplitudy skoku na wyjœciu AQ0002
skokI = 5000;       %USER   ró¿nica amplitudy skoku na wejœciu AI0003
k = skokI/skokQ;    % wartoœæ skoku

n = 3;              % USER n obliczamy dziel¹c T1/T2 i szukamy tej wartoœci 
